...
var (
	validators = []Validator{
		NewValidator(valAddr1, pk1, stakingtypes.Description{}),
		NewValidator(valAddr2, pk2, stakingtypes.Description{}),
		NewValidator(valAddr3, pk3, stakingtypes.Description{}),
	}
	header = abci.Header{
		ChainID: "hello",
		Height:  5,
